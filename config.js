...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "CR7 the goat",
  packname: process.env.PACK_NAME || "CR7 the goat",
  botname : process.env.BOT_NAME  || "Jaden MD",
  ownername:process.env.OWNER_NAME|| "CR7 the goat",
